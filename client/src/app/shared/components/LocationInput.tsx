...
export default function LocationInput<T extends FieldValues>(props: Props<T>) {
    ...
    const locationUrl = 'https://api.locationiq.com/v1/autocomplete?key=pk.23fee277084f5d006508748e5d1ca441&limit=5&dedupe=1&'
                ...
                <List sx={{ border: 1 }}>
                    {suggestions.map(suggestions => (
                        <ListItemButton
                            ...
                            onClick={() => handleSelect(suggestions)}>{suggestions.display_name}</ListItemButton>
                    ))}
                </List>
            )}
        </Box>
